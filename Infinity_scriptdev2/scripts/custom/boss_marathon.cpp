...
bool GOHello_go_klec_jau(Player* pPlayer, GameObject* pGO)
{
...
bool GOHello_bahamut_portzpet(Player* pPlayer, GameObject* pGO)
{
...
bool GOHello_bahamut_crystal(Player* pPlayer, GameObject* pGO)
{
...
void AddSC_boss_marathon()
{
	...
	newscript->pGOHello = GOHello_go_klec_jau;
	newscript->RegisterSelf();
	...
	newscript->pGOHello = &GOHello_bahamut_portzpet;
	newscript->RegisterSelf();
	...
	newscript->pGOHello = &GOHello_bahamut_crystal;
	newscript->RegisterSelf();
