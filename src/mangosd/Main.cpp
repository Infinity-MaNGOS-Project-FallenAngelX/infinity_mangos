...
extern int main(int argc, char **argv)
{
    ...
    sLog.outString( "<Ctrl-C> to stop.\n\n" );
     ...
     sLog.outTitle( "               P   R   O   J   E   C   T __ TheFallen_WoW __                  ");	
    sLog.outTitle( "              A Special Made Core For & By FallenAngelX                        ");	
    sLog.outTitle( ":::::::::      :::     :::        :::     ::::::::   :::::::::                 ");
	sLog.outTitle( ":+:          :+: :+:   :+:        :+:     :+:        :+:    :+:                ");
	sLog.outTitle( "+:+         +:+   +:+  +:+        +:+     +:+        +:+     +:+               ");
    sLog.outTitle( "+:+::::::   #++:++#++: +#+        +#+     +#++:++#   +#+     +#+               ");
    ...
    sLog.outTitle( "#+#        #+#     #+# #+#        #+#     #+#        #+#     #+#               ");
    sLog.outTitle( "###        ###     ### #######    ####### ########   ###     ###               ");
    sLog.outTitle( "Special Made Core By and for FallenAngelX 3.3.5 Personal Core                  ");	
	sLog.outTitle( "Github.com/fallenangelX/(Retired Developer From Hellscream & Dark_Ice)"         );
	sLog.outTitle( "Project The Fallen World of Warcraft Server 3.3.5                              ");
